...
const services = [
  ...
  {
    no:"04",
    title:"Kitap Kapağı & Basılı Yayın",
    traits:["Özgün Kapak","Bandrollü Basım","Fizikî Dağıtım"],
    badge:"Kitabınız Raflarda Yerini Alsın",
    text:"Eseriniz için özgün kapak tasarımı hazırlıyor; bandrollü basım sürecini, baskı hazırlığını ve fizikî kitabınızın online kitap satış kanalları ile dağıtım ağlarında yer almasına yönelik yayın sürecini birlikte yürütüyoruz.",
