  ...
  return (
    <main className="legal-page">
      <div className="legal-page-inner">
        ...
        <p>Site içeriği Figan Yayınevi'nin yayıncılık hizmetleri hakkında genel bilgi vermek amacıyla hazırlanmıştır. Hizmet kapsamı, süre, ücret ve yayın koşulları başvuru sonrasında ayrıca netleştirilir.</p>
        ...
        <h2>İletişim</h2>
        <p>Sorularınız için <a href="mailto:info@figanyayinevi.com">info@figanyayinevi.com</a> adresinden bize ulaşabilirsiniz.</p>
      </div>
    </main>
  );
}